...
const Contact = () => {
  return (
    <section className="relative py-32 px-6">
      ...
      {/* Glass Card */}
      <div className="max-w-6xl mx-auto relative z-10 bg-white/15 backdrop-blur-2xl border border-yellow-400/30 shadow-[0_8px_60px_rgba(255,215,0,0.2)] rounded-3xl p-12 md:p-16">
        <motion.h2
        ...
        >
          Get in Touch with Ambe Jewellers
        </motion.h2>
